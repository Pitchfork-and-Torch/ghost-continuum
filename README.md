...
<p align="center">
 <img src="https://img.shields.io/badge/version-3.3.7-5ec8c0?style=flat-square" alt="version" />
 <img src="https://img.shields.io/badge/design-Crystal%20Nexus-8eb8c8?style=flat-square" alt="design" />
...
**Ghost Continuum** is a local-first **Living Digital Immune System**: polymorphic deception that evolves, morphs, contains, and seals. Version **3.3.7 Crystal Nexus** elevates the Command Nexus into a tabbed membrane cockpit (hover-expand map, Ghost LAN tab, simple help tips) while keeping the Luminous Membrane design system: calm scientific elegance, soft adaptive membranes, crystalline precision - without changing defensive scope or zero-core-deps discipline.
