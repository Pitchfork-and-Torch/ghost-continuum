...
<p align="center">
 ...
 <img src="https://img.shields.io/badge/version-3.6.3-5ec8c0?style=flat-square" alt="version" />
 <img src="https://img.shields.io/badge/design-Crystal%20Seal-8eb8c8?style=flat-square" alt="design" />
...
**Ghost Continuum** is a local-first **Living Digital Immune System**: polymorphic deception that evolves, morphs, contains, and seals. Version **3.6.3 Crystal Seal** starts Ghost LAN as a hidden child of the hub (no `cmd` trampoline, no detached console) and opens the browser without `cmd /c start`. Defensive scope and zero-core-deps discipline are unchanged.
