...
From Windows: `npm run deploy:site` then `npm run deploy:seo` (Crystal Seal, Pages fallback, live `dataset.version`, versioned tweet-card; 403 challenge is non-fatal).
