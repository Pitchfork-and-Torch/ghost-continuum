/**
 * Ghost Continuum v3.6 Air-Gap Map - Command Nexus orchestrator.
...
/** Same-origin cookie so EventSource (no custom headers) can pass the read-path lock. */
...
async function refreshOmega() {
 ...
 $('nxVersion').title = j.codename || CODENAME;
 }
