...
import { spawnHidden, openLocalUrl } from '../../core/src/silent-spawn.js';
...
async function cmdStart(args) {
  ...
  // Keep a helper script for optional boot-task install. Do not invoke it
  // via `cmd /c start /MIN` - that flashes a console on every start.
  ...
  spawnHidden(process.execPath, [SENTINEL], { cwd: ROOT });
