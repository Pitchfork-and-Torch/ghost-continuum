...
// Wall clock so a hung probe cannot pin Actions (seen 2026-08-01). Do not unref.
const HARD_MS = Number(process.env.TRENCH_CLOAK_TEST_MS || 20000);
const hard = setTimeout(() => {
  console.error('trench-cloak: HARD TIMEOUT - exiting');
  process.exit(2);
}, HARD_MS);
